...
#define DB_ERROR_RECORD_JMP		0x00000012  // Faild jumping to the requested record
...
#define DB_ERROR_SORTLENGTH		0x00000100	// Offset and sortlength are larger then recordsize

#define DB_ERROR_NOT_FOUND		0x00001000	// Error string not found in any record of the database

//-----------------------------------------------------------------------------
// Purpose:     Return the last occured error code
//
// Parameters:  None
//
// Returns:     long		- error code see description of the errocodes the defines above
//
...
//				record		- pointer to record buffer
//
//				searchkey	- the string to earch for in the database
//
...
// Parameters:  dbIndex		- pointer to an open index database handle
//
//				searchkey	- the searchkey that neads to be added to the index file
//
